...
@Component({
  ...
  template: `
    <div
      class="min-w-[250px] p-2 flex justify-between items-center gap-4 bg-gray-50 rounded-full shadow-sm hover:bg-gray-100 transition-colors duration-100 cursor-default"
    >
